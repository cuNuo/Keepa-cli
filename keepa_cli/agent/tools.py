...
RESEARCH_BRIEF_EXPORT_SCHEMA: JsonSchema = {
    ...
    "properties": {
        ...
        "out_dir": _string_schema("Optional directory for a commit-ready brief JSON when out is not supplied."),
        "external_signal_stub": {
            "oneOf": [{"type": "object"}, {"type": "array", "items": {"type": "object"}}],
            "description": "External ad/media/search evidence collected outside Keepa, merged into the brief without web access.",
        },
        "ip_risk_inputs": {
            "oneOf": [{"type": "object"}, {"type": "array", "items": {"type": "object"}}],
            "description": "Patent/IP/FTO evidence inputs collected outside Keepa.",
        },
        "claim_risk_inputs": {
            "oneOf": [{"type": "object"}, {"type": "array", "items": {"type": "object"}}],
            "description": "Product claim, compliance, and marketplace policy evidence inputs collected outside Keepa.",
        },
        "from_cache": _string_schema("Session cache key to reuse."),
    },
...
REPORTS_BUILD_SCHEMA: JsonSchema = {
    ...
    "properties": {
        ...
        "out_dir": _string_schema("Optional directory for a commit-ready report when out is not supplied."),
