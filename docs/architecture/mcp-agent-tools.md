...
- 官方 Python MCP SDK adapter 对照见 `docs/architecture/mcp-python-sdk-adapter-comparison.md`；结论是先保留当前 stdio 生产入口，再用 `keepa_cli/agent/mcp_sdk_adapter.py` 和 `scripts/compare_mcp_sdk_adapter_fixture.py` 对比 Inspector 兼容性。
